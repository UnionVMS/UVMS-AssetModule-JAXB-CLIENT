 ...
 * 2015-09-28T19:30:34.249+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "BridgeConnectorService", 
                  wsdlLocation = "file:/C:/Projekt/release_salome/Modules/Vessel/JAXB-CLIENT/eu-vessel-service-sender/src/main/resources/contract/connector-bridge.wsdl",
...
public class BridgeConnectorService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Projekt/release_salome/Modules/Vessel/JAXB-CLIENT/eu-vessel-service-sender/src/main/resources/contract/connector-bridge.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BridgeConnectorService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Projekt/release_salome/Modules/Vessel/JAXB-CLIENT/eu-vessel-service-sender/src/main/resources/contract/connector-bridge.wsdl");
        }
        WSDL_LOCATION = url;
    }
